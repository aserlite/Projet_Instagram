...
<body>
  ...
  <form action="index.php?action=search" method='post'>
      <input type="text" <?php if(isset($_SESSION['search'])){echo "placeholder=".$_SESSION['search'];}else{ echo 'placeholder="Votre recherche"';}?> name="search" class="searchbar" required="required"> 
